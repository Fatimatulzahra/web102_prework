...
const unfundedMessage = totalUnfunded > 0 ? `Currently, ${totalUnfunded} game${totalUnfunded > 1 ? 's' : ''} remain unfunded.` : "All of our games have met their funding goals!";

// create a new DOM element containing the template string and append it to the description container
const infoElement = document.createElement("p");
infoElement.innerHTML = unfundedMessage;
...
runnerUpElement.innerHTML = `🥈 Runner Up: ${runnerUp.name}`;
